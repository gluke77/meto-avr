...
char * sensor_text[][3] =
	{
		...
		{"ÑÃ ÎÏÓÙÅÍÀ       ", "ÄÀ", "ÍÅÒ"},
		{"ÎÁÐÛÂ ÔÎËÜÃÈ     ", "ÄÀ", "ÍÅÒ"},
		{"ÊÎÍÅÖ ÎÑÍ. ÁÎÁÈÍÛ", "ÄÀ", "ÍÅÒ"},
		{"ÊÎÍÅÖ ÄÎÏ. ÁÎÁÈÍÛ", "ÄÀ", "ÍÅÒ"}
	};
...
void menu_controls(void)
{
	...
	lcd_line1[SOFT_CONTROL_PRESSURE] = (TEST_SOFT_CONTROL(SOFT_CONTROL_PRESSURE))?'Ä':'.';
	...
	lcd_line1[SOFT_CONTROL_FOIL_LED - 2] = (TEST_SOFT_CONTROL(SOFT_CONTROL_FOIL_LED))?'Ë':'.';
	lcd_line1[SOFT_CONTROL_BUNKER_MOTOR - 2] = (TEST_SOFT_CONTROL(SOFT_CONTROL_BUNKER_MOTOR))?'Á':'.';
	lcd_line1[SOFT_CONTROL_TRACTOR_LOCK - 2] = (TEST_SOFT_CONTROL(SOFT_CONTROL_TRACTOR_LOCK))?'Ï':'.';
...
{	
	sprintf(lcd_line0,"ÄÀÂËÅÍÈÅ        ");
	sprintf(lcd_line1,"%s                ", 
		(TEST_SOFT_CONTROL(SOFT_CONTROL_PRESSURE))?"ÂÊËÞ×ÅÍÎ":"ÂÛÊËÞ×ÅÍÎ");
...
void menu_stop(void)
{	
	sprintf(lcd_line0,"ÑÈÃÍÀË 'ÑÒÎÏ'   ");
	sprintf(lcd_line1,"%s                ", 
		(TEST_SOFT_CONTROL(SOFT_CONTROL_STOP))?"ÂÊËÞ×ÅÍ":"ÂÛÊËÞ×ÅÍ");
